...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.falcon.base.version";
    public static final String PROP_DEVICE = "ro.build.product";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.falcon.buildtype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "falcon.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "falcon.updater.uri";
    public static final String PROP_ZIP_TYPE = "ro.falcon.ziptype";
